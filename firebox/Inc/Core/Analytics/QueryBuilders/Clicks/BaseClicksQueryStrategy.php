...
abstract class BaseClicksQueryStrategy extends BaseQueryStrategy
{
	/**
	 * Clicks uses logs_details table as primary date column
	 */
	...
	/**
	 * Clicks-specific FROM/JOIN logic
	...
	/**
	 * Clicks metrics use 'bl' alias for logs table
	 */
