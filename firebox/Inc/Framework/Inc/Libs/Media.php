...
class Media
{
	...
	{
		// Check if user has access to FireBox backend - use read_fireboxes capability
		// This allows clients to give users access to FireBox without full admin privileges
