 ...
 * 
 * Plugin Name:       FireBox 2.1.39 Free
...
{
	define('FBOX_GO_PRO_URL', 'https://www.fireplugins.com/firebox/upgrade?utm_source=product&utm_campaign=firebox-' . (FBOX_LICENSE_TYPE === 'lite' ? 'free' : 'pro') . '&utm_medium=pro-feature');
}
...
{
	define('FBOX_RELEASE_DATE', '2025-07-10');
}
